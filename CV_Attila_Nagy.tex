...
\EducationEntry{MSc. Computer Science}{2012-Present}{University of Gothenburg and Chalmers University of Technology, Sweden}{The only leftover from my Master's program is the final presentation of my thesis which is schedule for the 28th of April, 2014. Most of the courses that I took during this program were in the fields of distributed systems and computer networks, but just to broaden my knowledge I also took courses that do not fit into these two fields, such as Artificial Intelligence and Functional Programming. The exact list of course can be found in my Transcript of Records.}
\sepspace
...
\SkillsEntry{Programming:}{C/C++, Python, Perl, BASH, TNSDL, Haskell}
\sepspace
