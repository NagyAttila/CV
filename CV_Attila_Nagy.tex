...
\EducationEntryNoTime{Nokia Siemens Networks Years}{In this project I mainly was occupied by unit testing using a Nokia specific language, call TNSDL. Later I moved to DXA, a project started from scratch requiring more complex and deeper knowledge.}
